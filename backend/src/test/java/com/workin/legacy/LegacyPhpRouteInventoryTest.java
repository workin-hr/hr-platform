...
class LegacyPhpRouteInventoryTest {
	...
	private static final List<String> EXPECTED_ROUTES = List.of(
			...
			"/apis/api/auth/check_status.php", "/apis/api/auth/complete_company_registration.php",
			"/apis/api/auth/get_company_registration_options.php", "/apis/api/auth/join_company.php",
			"/apis/api/auth/login_company.php", "/apis/api/auth/login_desktop.php",
			"/apis/api/auth/lookup_company.php", "/apis/api/auth/register_company.php",
			...
			"/apis/api/company_join_requests/accept.php",
			"/apis/api/company_join_requests/list.php",
			"/apis/api/company_join_requests/reject.php",
			"/apis/api/complaints/create.php", "/apis/api/complaints/delete.php",
			"/apis/api/complaints/list.php", "/apis/api/complaints/update.php",
			"/apis/api/employee_docs/delete.php", "/apis/api/employee_docs/list.php",
			"/apis/api/employee_docs/update.php", "/apis/api/employee_docs/upload.php",
	...
	/**
	 * D-156: the attendance-device receiver is default-closed. This context
