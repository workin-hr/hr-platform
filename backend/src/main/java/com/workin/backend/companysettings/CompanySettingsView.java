...
public record CompanySettingsView(
		...
		BigDecimal overtimeRate, BigDecimal monthlyLeaveAccrual, Boolean payOvertime) {

	static final CompanySettingsView UNSET = new CompanySettingsView(null, null, null, null, null, null);
	...
	static CompanySettingsView of(CompanySettings s) {
		return new CompanySettingsView(
				...
				s.getOvertimeRate(), s.getMonthlyLeaveAccrual(), s.getPayOvertime());
	}
