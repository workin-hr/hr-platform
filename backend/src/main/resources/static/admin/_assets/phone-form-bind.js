  ...
  function bindPhoneForms() {
    ...
    document.querySelectorAll('form').forEach(function (form) {
      ...
      form.addEventListener('submit', function (event) {
        ...
        // stored rows hold pairs no rule accepts, such as a joined employee's
        ...
        // Whether the number is valid is the server's to say (D-291); the only
        // refusal here is a phone with no country to read it in.
