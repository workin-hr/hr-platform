...
## D-273: The Site Visit Gets A Local Page, And Every Step Becomes Repeatable On Its Own
...
| Related | **D-272** (the field fixes this is built on, and the failure that made a repeatable step worth having), **#291** (the visit command), `docs/devices/field-visit-runbook.md` (the quick path), `docs/devices/on-prem-agent.md` (the command table), D-258. |
