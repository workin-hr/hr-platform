...
| Field | Value |
|---|---|
| Status | **Proposed — owner decision owed.** Nothing changes until it is answered. Raised by R-008's fourth realisation, and deliberately kept out of that incident's remediation (#190, #191): this is a standing governance change, and deciding it inside an incident fix is how a change of this weight avoids scrutiny. |
| Owner | Repository owner |
