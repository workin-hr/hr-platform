...
| Probability | High (currently true, not speculative) |
| Impact | High — every open pull request (#117, #118, #119, #120, #121) is unreviewable by Codex and unable to get a real (non-billing) CI signal until a human acts outside this repository |
| Severity | High |
