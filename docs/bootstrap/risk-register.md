...
| Status | Open — **not accepted**. Recorded during the Wave 13.1b port; the endpoint ships in parity form because that is Phase 1's contract, and this entry exists so that shipping it is a visible decision rather than a silent one. |
