...
These 16 skills follow this repository's own procedure schema (see
...
## Why The 16 Repository-Authored Skills Are Not Also Under `.claude/skills/`
...
Doing the same for these 16 would mean maintaining two copies of every
