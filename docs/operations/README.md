...
- `checking-against-the-live-database.md` — the backend in Docker against the MySQL PHP still serves: the fourteen tables Java adds, the three settings that differ against real data, and how the mobile, desktop and admin clients point at it
