...
until 2026-09-02 — see the update at the end of this section (D-213).**
...
**Update 2026-09-02 — Part B resolved (D-213, accepted the same day; hardware check outstanding).**
...
owner accepted it on 2026-09-02 (D-213)**, with one recorded condition: a
...
**Update 2026-09-02 (D-214) — the gate is explicit.** The hardware checklist
...
tenant admin from a serial number (**R-072**), with an audited
...
B (D-213), which the owner accepted the same day with the hardware checklist
...
- ~~whether ZKTeco devices need a local network gateway or connect via
  direct cloud API/push webhook~~ — **Resolved 2026-09-02 (D-213,
