...
مابيقولوش حاجة، والأمر ساعتها بيقرأ **توزيع الكودين في سجل الجهاز كله**: أي حد بيدخل
بيخرج، فعمود الدخول/الخروج بيبقى شبه متوازن في آلاف البصمات، والعمود اللي بيسجّل الموظف
أثبت نفسه إزاي مابيبقاش كده. مثال من جهاز حقيقي: <span dir="ltr">`punch`</span> اتقسم
5779 / 5640، و<span dir="ltr">`status`</span> كان 1 في 11424 بصمة و15 في بصمتين بس —
البصمتين دول مش معناهم إن العمود ده بيفرّق بين دخول وخروج. النتيجة والتوزيع الاتنين
بيتكتبوا في ورقة النتائج. لو لسه مش واضح، اكتب التوزيع في الـ issue: الأرقام دي هي
الدليل، مش تخمين.
...
| <span dir="ltr">`[Errno 113] No route to host`</span> | شبكة اللابتوب: الـ ARP فشل ومفيش ولا حزمة وصلت للجهاز، فالجهاز ماقالش حاجة | **دي مش مشكلة في الجهاز وماتكتبهاش في issue الأجهزة.** الأمر بيكتب أرقام الشبكة لوحده (واي فاي dBm، حالة ARP، ping ومكرراته). قرّب اللابتوب من الراوتر، أو اتوصّل بكابل، وبعدين كرّر الخطوة |
...
| شبكة اللابتوب وقت المشكلة | الواي فاي ... dBm، ARP ...، ping ... |
| مشاكل تانية | |
